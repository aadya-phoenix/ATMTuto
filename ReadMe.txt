Step 1: Double Click on ATMTuto.sln
Step2 : In the shared folder, copy the database file called "ATMDb.mdf" and paste it in your documents
...
SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\username\Documents\ATMDb.mdf;Integrated Security=True;Connect Timeout=30");
